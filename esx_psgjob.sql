...
(60, 'psg', 1, 'aprendiz', 'Aprendiz', 12, '{}', '{}'),
    (61, 'psg', 2, 'empleado', 'Empleado', 0, '{}', '{}'),
    (62, 'psg', 3, 'supervisor', 'Supervisor', 0, '{}', '{}'),
    (63, 'psg', 4, 'auxiliar', 'Auxiliar', 0, '{}', '{}'),
    (64, 'psg', 5, 'experimentado', 'Experimentado', 0, '{}', '{}'),
    (65, 'psg', 6, 'gerente', 'Gerente', 0, '{}', '{}'),
    (66, 'psg', 7, 'seguridad', 'Seguridad del Cuerpo', 0, '{}', '{}'),
    (67, 'psg', 8, 'especialista', 'Especialista del Cuerpo', 0, '{}', '{}'),
    (68, 'psg', 9, 'instructor', 'Instructor Del Cuerpo', 0, '{}', '{}'),
    (69, 'psg', 10, 'subdirector', 'Sub Director', 0, '{}', '{}'),
    (70, 'psg', 11, 'director', 'Director', 0, '{}', '{}'),
    (71, 'psg', 12, 'subjefe', 'Sub Jefe', 0, '{}', '{}'),
    (72, 'psg', 13, 'jefe', 'Jefe', 0, '{}', '{}'),
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de psg',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de psg',110,1),
